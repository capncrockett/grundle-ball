...
| Restricted Megalabowl mirror   | [layout](../frontend/src/components/MegalabowlLayout.tsx), [league config](../frontend/src/config/league.ts), [access gate](../frontend/src/draftIntelAccess.ts) | [App routing](../frontend/src/App.test.tsx), leagueId tests in [Standings](../frontend/src/pages/StandingsPage.integration.test.tsx), [Matchups](../frontend/src/pages/MatchupsPage.integration.test.tsx), [Playoffs](../frontend/src/pages/PlayoffsPage.integration.test.tsx), [production boundary](../frontend/tests/e2e/production-boundary.spec.ts) |
