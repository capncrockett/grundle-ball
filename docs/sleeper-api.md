...
Individual league-mock IDs remain readable through the public draft and pick endpoints. `postKeeperMockDraftSource.ts` therefore records the 10 most recent IDs supplied for the 2026 post-lock batch. Live validation on 2026-09-06 confirmed all 10 were `league_mock` boards for league `1385053148233621511`, created that day, complete at 192 picks, and contained all 20 current Keeper Designations at exact picks.
